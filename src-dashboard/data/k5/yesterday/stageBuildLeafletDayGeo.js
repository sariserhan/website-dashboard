...
//Leaflet integration file for chartjs dashboard. Do not modify - COSMIC UCAR
  ...
  var html_geooptrt_fm_01_good = L.geoJson([geooptrt_fm_01_good], {
  ...
  html_geooptrt_fm_01_good.addTo(map);
  controlLayers.addOverlay(html_geooptrt_fm_01_good, 'GEOOPTRT FM 01 Good');

  var html_geooptrt_fm_03_good = L.geoJson([geooptrt_fm_03_good], {
    style: function (feature) {
      return feature.properties && feature.properties.style;
    },
    onEachFeature: onEachFeature,
  ...
  html_geooptrt_fm_03_good.addTo(map);
  controlLayers.addOverlay(html_geooptrt_fm_03_good, 'GEOOPTRT FM 03 Good');

  var html_geooptrt_fm_04_good = L.geoJson([geooptrt_fm_04_good], {
    style: function (feature) {
      return feature.properties && feature.properties.style;
    },
    onEachFeature: onEachFeature,
  ...
  html_geooptrt_fm_04_good.addTo(map);
  controlLayers.addOverlay(html_geooptrt_fm_04_good, 'GEOOPTRT FM 04 Good');
  ...
  legend.onAdd = function (map) {
    ...
    div.innerHTML += '<TR><TD valign=middle>&nbsp;&nbsp;<i style="background:#0686e8; width:12px; height:12px; margin-top:10px"></i>&nbsp;&nbsp;GEOOPTRT (Count 1153)<BR></TD></TR>'
