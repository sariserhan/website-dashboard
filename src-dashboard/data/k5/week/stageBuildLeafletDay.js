...
//Leaflet integration file for chartjs dashboard. Do not modify - COSMIC UCAR
  ...
  var html_kompsat5rt_fm_01_good = L.geoJson([kompsat5rt_fm_01_good], {
  ...
  html_kompsat5rt_fm_01_good.addTo(map);
  controlLayers.addOverlay(html_kompsat5rt_fm_01_good, 'KOMPSAT5RT FM 01 Good');
  ...
  legend.onAdd = function (map) {
    ...
    div.innerHTML += '<TR><TD valign=middle>&nbsp;&nbsp;<i style="background:#0686e8; width:12px; height:12px; margin-top:10px"></i>&nbsp;&nbsp;KOMPSAT5RT (Count 529)<BR></TD></TR>'
