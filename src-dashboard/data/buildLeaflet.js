...
//Leaflet integration file for chartjs dashboard. Do not modify - Adam
  ...
  var html_coseqrt_fm_02_good = L.geoJson([coseqrt_fm_02_good], {
    style: function (feature) {
      return feature.properties && feature.properties.style;
    },
    onEachFeature: onEachFeature,
  ...
  html_coseqrt_fm_02_good.addTo(map);
  controlLayers.addOverlay(html_coseqrt_fm_02_good, 'COSEQRT FM 02 Good');
  ...
  legend.onAdd = function (map) {
    ...
    div.innerHTML += '<TR><TD valign=middle>&nbsp;&nbsp;<i style="background:#0686e8; width:12px; height:12px; margin-top:10px"></i>&nbsp;&nbsp;COSEQRT (Count 36244)<BR></TD></TR>'
