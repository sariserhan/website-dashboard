...
//Leaflet integration file for chartjs dashboard. Do not modify - COSMIC UCAR
  ...
  var html_pazrt_fm_01_good = L.geoJson([pazrt_fm_01_good], {
  ...
  html_pazrt_fm_01_good.addTo(map);
  controlLayers.addOverlay(html_pazrt_fm_01_good, 'PAZRT FM 01 Good');
  ...
  legend.onAdd = function (map) {
    ...
    div.innerHTML += '<TR><TD valign=middle>&nbsp;&nbsp;<i style="background:#0686e8; width:12px; height:12px; margin-top:10px"></i>&nbsp;&nbsp;PAZRT (Count 112)<BR></TD></TR>'
